        ...
        <div class="join">
            ...
            @foreach ($elements as $element)
                ...
                @if (is_string($element))
                    <button disabled class="btn join-item btn-disabled" aria-disabled="true"><span>{{ $element }}</span></li>
                @endif
                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <button class="btn join-item btn-active" aria-current="page"><span>{{ $page }}</span></li>
                        @else
